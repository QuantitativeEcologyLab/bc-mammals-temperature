...
```{r pred-vs-pred, fig.cap="Scatterplot of the fitted values from the HGAMs with and without including temperature for the probability of movement (\\textbf{A}) and speed when moving (\\textbf{B})."}
