...
\noindent \textbf{Words in main text}: 8373

\noindent \textbf{Figures}: 9

\noindent \textbf{Tables}: 3

\noindent \textbf{References}: 169 (updated on 2026-05-13)
...
{\centering \includegraphics[width=\textwidth]{../figures/distance} 
...
{\centering \includegraphics[width=\textwidth]{../figures/hrsf-surface-plots} 
...
{\centering \includegraphics[width=\textwidth]{../figures/distance-travelled-local-cc-predictions} 
...
{\centering \includegraphics[width=\textwidth]{../figures/rss-local-cc-predictions} 
...
{\centering \includegraphics[width=\textwidth]{../figures/local-rss-2100-density} 
...
\bibitem[\citeproctext]{ref-mclellan_effect_2015}
McLellan ML, McLellan BN (2015) \href{https://doi.org/10.1371/journal.pone.0117734}{Effect of {Season} and {High} {Ambient} {Temperature} on {Activity} {Levels} and {Patterns} of {Grizzly} {Bears} ({Ursus} arctos)} (ed Crocker DE). \emph{PLOS ONE}, \textbf{10}, e0117734.
