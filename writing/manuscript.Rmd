...
The three habitat variables were nonlinearly correlated. Within the boreal caribou range (Fig. \@ref(fig:boreal-rss)A), locations with an elevation of 0.9-1.1 km had a median forest cover of 100% and a median distance to water of 1.8 km. In contrast, elevations above 1750 m did not have forest cover above 90% and had a median distance to water of 1.5 km. Local predictions of RSS revealed that boreal caribou and wolves selected for similar habitats (Fig. \@ref(fig:boreal-rss)B), but caribou tended to avoid the river system that wolves strongly selected for. Both species selected for the same loop of low-elevation habitat (< 500 m), but their selection strength for the area varied with temperature. For caribou, selection for the area was stronger at -20$^\circ$C and weaker at warmer temperatures, while, for wolves, selection was stronger at +20$^\circ$C. Both species' HRSFs indicated selection against elevations approximately between 0.5 km and 0.9 km but selection for elevations approximately above 0.9 km. After data cleaning and the removal of non-range-resident animals, the highest observed elevations were 1 km for caribou and 1.733 km for wolves. Quadrature points had maximum elevations of 1.1 km for caribou and 1.3 km for wolves.
