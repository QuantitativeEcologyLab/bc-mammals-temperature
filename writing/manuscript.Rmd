...
\noindent \textbf{References}: 163 (updated on 2025-09-29) <!-- counted using movement ecology csl -->
...
* thermal landscape?
* comon trends:
  * boreal species do not see much of a change in distance traveled, but this is in part due to opposite trends in the different seasons.
  * habitat selection for boreal species flattens with temperatures above 0 but strengthens near zero. Therefore, warmer summers may result in lower encounter rates as ranges widen, but warmer winters may result in increased predation risk, which may impact reproductive success (since cows are pregrant in winter)
  * SM caribou and mountain goats are projected to move more and see widespread decreases in their current habitats
